...
abstract class ExerciseDatabase: RoomDatabase() {
    ...
    companion object {
        ...
        fun populateDatabase(exerciseDao: ExerciseDao) {
            //BEGINNER - MORNING
            var newExercise = Exercise(R.drawable.beg_m_1,"Muktasana jest idealna pozą do chwili odpoczynku i medytacji. Ćwiczenie to ma na celu stopniowe rozbudzenie naszego organizmu po śnie i przygotowanie go do ruchu w następnych ćwiczeniach.W czasie trzech minut tego ćwiczenia skup się na głębokim i spokojnym oddechu.  Pamiętaj również o wyprostowanych plecach.",
                50,"Beginner", "Morning")
